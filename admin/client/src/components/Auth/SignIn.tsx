      ...
      <div className="w-100 p-3 p-md-5 card border-0 bg-dark text-light" style={{ maxWidth: "32rem" }}>
        <form className="row g-1 p-3 p-md-4">
          ...
          <div className="col-12 text-center mt-4">
            <Link to={`${process.env.REACT_APP_BASE_URL}/hr-dashboard`} className="btn btn-lg btn-block btn-light lift text-uppercase" >SIGN IN</Link>
          </div>
          <div className="col-12 text-center mt-4">
            <span className="text-muted">Don't have an account yet? <Link to={`${process.env.REACT_APP_BASE_URL}/sign-up`} className="text-secondary">Sign up here</Link></span>
          </div>
        </form>
      </div>
    </div>
