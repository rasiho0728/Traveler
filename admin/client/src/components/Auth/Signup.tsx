      ...
      <div className="w-100 p-3 p-md-5 card border-0 bg-dark text-light" style={{ maxWidth: "32rem" }}>
        <form className="row g-1 p-3 p-md-4">
          ...
          <div className="col-12 text-center mt-4">
            <Link to={`${process.env.REACT_APP_BASE_URL}/sign-in`} className="btn btn-lg btn-block btn-light lift text-uppercase">SIGN UP</Link>
          </div>
          <div className="col-12 text-center mt-4">
            <span className="text-muted">Already have an account? <Link to={`${process.env.REACT_APP_BASE_URL}/sign-in`} title="Sign in" className="text-secondary">Sign in here</Link></span>
          </div>
        </form>
      </div>
    </div>
