...
const CurrentClientProject: React.FC<{ teamImage: any, logo: any, logoBg: any, title: any, sl: any, onClickEdit?: any, onClickDelete?: any, onClickAdd?: any }> = (props) => {
      ...
      <div className="card-body">
        ...
        <div className="d-flex align-items-center">
          <div className="avatar-list avatar-list-stacked pt-2">
            {
              teamImage.map((d: any, i: number) => <img key={"ihihb" + i} className="avatar rounded-circle sm" src={d} alt=" " />)
            }
