    ...
    <div className="col-12">
      <div className="card p-4 bd-content">
        ...
        <div className="bd-example mb-5">
          <h1>Example heading <Badge className="bg-secondary">New</Badge></h1> {/*variant="secondary"*/}
          <h2>Example heading <Badge className="bg-secondary">New</Badge></h2> {/*variant="secondary"*/}
          <h3>Example heading <Badge className="bg-secondary">New</Badge></h3> {/*variant="secondary"*/}
          <h4>Example heading <Badge className="bg-secondary">New</Badge></h4> {/*variant="secondary"*/}
          <h5>Example heading <Badge className="bg-secondary">New</Badge></h5> {/*variant="secondary"*/}
          <h6>Example heading <Badge className="bg-secondary">New</Badge></h6> {/*variant="secondary"*/}
...
<h6>Example heading <Badge variant="secondary" className="bg-secondary">New</Badge></h6>`}
        ...
        <div className="bd-example mb-5">
          <button type="button" className="btn btn-primary">
            Notifications <Badge className="bg-secondary">9</Badge> {/* variant="light" */}
          </button>
          <SyntaxHighlighter language="javascript" className="mt-2 language-html" style={a11yLight}>
            {`<button type="button" className="btn btn-primary">
Notifications <Badge variant="light" className="bg-secondary">9</Badge>
        ...
        <div className="bd-example mb-5">
          <button type="button" className="btn btn-primary">
            Profile <Badge className="bg-secondary">9</Badge> {/* variant="light" */}
          </button>
    ...
    Profile <Badge variant="light" className="bg-secondary">9</Badge>
        ...
        <div className="bd-example mb-5">
          <Badge className="bg-primary" bg="primary">Primary</Badge>{' '} {/*variant="primary"  */}
          <Badge className="bg-success">Secondary</Badge>{' '} {/*variant="secondary"*/}
          <Badge className="bg-danger">Success</Badge>{' '} {/*variant="success"  */}
          <Badge className="bg-warning">Danger</Badge>{' '} {/*variant="danger"   */}
          <Badge className="bg-info">Warning</Badge> {' '} {/*variant="warning"  */}
          <Badge className="bg-info">Info</Badge>{' '} {/*variant="info"     */}
          <Badge className="bg-light">Light</Badge> {' '} {/*variant="light"    */}
          <Badge className="bg-dark">Dark</Badge>{/*variant="dark"     */}
          <SyntaxHighlighter language="javascript" className="mt-2 language-html" style={a11yLight}>
...
<Badge variant="dark" className="bg-dark">Dark</Badge>`}
        ...
        <div className="bd-example mb-5">
          <Badge pill className="rounded-pill bg-secondary">Primary</Badge>{' '} {/* variant="primary"    */}
          <Badge pill className="rounded-pill bg-success">Secondary</Badge>{' '} {/* variant="secondary"  */}
          <Badge pill className="rounded-pill bg-danger">Success</Badge>{' '} {/* variant="success"    */}
          <Badge pill className="rounded-pill bg-warning">Danger</Badge>{' '} {/* variant="danger"     */}
          <Badge pill className="rounded-pill bg-info">Warning</Badge> {' '} {/* variant="warning"    */}
          <Badge pill className="rounded-pill bg-info">Info</Badge>{' '} {/* variant="info"       */}
          <Badge pill className="rounded-pill bg-light">Light</Badge> {' '} {/* variant="light"      */}
          <Badge pill className="rounded-pill bg-dark">Dark</Badge> {/* variant="dark"       */}
          <SyntaxHighlighter language="javascript" className="mt-2 language-html" style={a11yLight} >
