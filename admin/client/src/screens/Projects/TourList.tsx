...
import TestCard from "../../components/Clients/testCard";
        ...
        <PageHeader headerTitle="Tour List"
          ...
          {/* <div className="col-md-4 ftco-animate">
            <div className="destination">
                <Link to="/tourlist/tourdetail/1" className="img img-2 d-flex justify-content-center align-items-center" }}>
        ...
        <Modal.Body>
          ...
          <div className="mb-3">
            ...
            <select className="form-select" value={editModeldata ? editModeldata.title : ""}>
              <option >TourList1</option>
              <option value="1">TourList2</option>
              <option value="2">TourList3</option>
