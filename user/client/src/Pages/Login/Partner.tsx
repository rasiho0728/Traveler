...
const Partner: React.FC = () => {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        console.log("작성한 정보로 회원가입 진행 중", { id, password, name, ssn, phone, email, company, companyType });
    };
                    ...
                    <form className="login100-form validate-form" onSubmit={handleSubmit}>
                        ...
                        <div className="wrap-input100 validate-input m-b-15">
                            ...
                            >
                                ...
                                <option value="1차 산업군">숙박시설</option>
                                <option value="2차 산업군">교통</option>
                                <option value="3차 산업군">기타</option>
                            </select>
                        </div>
